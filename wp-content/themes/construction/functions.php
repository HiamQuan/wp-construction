...
function construction_register_home_cpts()
{
	register_post_type(
		...
		array(
			'labels'       => array(
				'name'          => __('product', 'construction'),
				'singular_name' => __('product', 'construction'),
				'add_new'       => __('Add product', 'construction'),
				'add_new_item'  => __('Add product new', 'construction'),
				'edit_item'     => __('Edit product', 'construction'),
				'all_items'     => __('All product', 'construction'),
			),
			'public'       => true,
			'show_ui'      => true,
			'show_in_menu' => true,
...
/**
 * Category thumbnail (image URL) meta for product categories.
 * Allows setting a separate image per category, independent of products.
 */
...
function construction_save_featured_project_meta($post_id)
{
	...
	if (get_post_type($post_id) !== 'construction_product') {
		return;
	}
...
add_action('save_post_construction_product', 'construction_save_featured_project_meta');
